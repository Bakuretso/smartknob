...
Этот проект распространяется по лицензиям Apache v2 (ПО, электроника, документация) и Creative Commons Attribution 4.0 (железо/механика) (см. [LICENSE.txt](LICENSE.txt) и [Creative Commons](https://creativecommons.org/licenses/by/4.0/)).
